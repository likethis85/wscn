<?php
    ...
    $key_5  = array_slice($numbers, 200, 6);
    $key_6  = array_slice($numbers, 300, 6);
    ...
    for ($i=0; $i<6; $i++) {
        if (isset($discovery_5[$i])) {
            continue;
        }

        $discovery_5[$i] = $discovery[$key_5[$i]];
    }

    for ($i=0; $i<6; $i++) {
        if (isset($discovery_6[$i])) {
            continue;
        }

        $discovery_6[$i] = $discovery[$key_6[$i]];
    }


    $test[] = array('url' => 'http://w.cn/node/65136', 'img' => 'http://img.wallstreetcn.com/sites/default/files/MI-BZ892_CYIELD_G_20131125180907.jpg', 'title' => '美国9月S&P/CS房价指数同比增长超预期 环比增幅7个月最低');
    $test[] = array('url' => 'http://w.cn/node/65136', 'img' => 'http://img.wallstreetcn.com/sites/default/files/MI-BZ892_CYIELD_G_20131125180907.jpg', 'title' => '美国9月S&P/CS房价指数同比增长超预期 环比增幅7个月最低');
    $test[] = array('url' => 'http://w.cn/node/65136', 'img' => 'http://img.wallstreetcn.com/sites/default/files/MI-BZ892_CYIELD_G_20131125180907.jpg', 'title' => '美国9月S&P/CS房价指数同比增长超预期 环比增幅7个月最低');
    $test[] = array('url' => 'http://w.cn/node/65136', 'img' => 'http://img.wallstreetcn.com/sites/default/files/MI-BZ892_CYIELD_G_20131125180907.jpg', 'title' => '美国9月S&P/CS房价指数同比增长超预期 环比增幅7个月最低');
    $test[] = array('url' => 'http://w.cn/node/65136', 'img' => 'http://img.wallstreetcn.com/sites/default/files/MI-BZ892_CYIELD_G_20131125180907.jpg', 'title' => '美国9月S&P/CS房价指数同比增长超预期 环比增幅7个月最低');
    $test[] = array('url' => 'http://w.cn/node/65136', 'img' => 'http://img.wallstreetcn.com/sites/default/files/MI-BZ892_CYIELD_G_20131125180907.jpg', 'title' => '美国9月S&P/CS房价指数同比增长超预期 环比增幅7个月最低');
    $GLOBALS['discovery_1'] = $discovery_1;
    $GLOBALS['discovery_2'] = $discovery_2;

    $GLOBALS['discovery_3'] = $discovery_3;
    $GLOBALS['discovery_4'] = $discovery_4;
    $GLOBALS['discovery_5'] = $discovery_5;
    $GLOBALS['discovery_6'] = $discovery_6;
