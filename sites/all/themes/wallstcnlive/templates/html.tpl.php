<!DOCTYPE html>
<?
$styles = str_ireplace('http://live.wallstreetcn.com', 'http://img.wallstreetcn.com', $styles);
$scripts = str_ireplace('http://live.wallstreetcn.com', 'http://img.wallstreetcn.com', $scripts);
?>
...
<head>
    ...
    <?endif?>
    <?else:?>
    <title>华尔街见闻_中国最专业金融资讯平台_实时新闻_华尔街见闻实时新闻_华尔街实时新闻_见闻实时新闻_实时新闻直播_华尔街见闻直播_见闻直播</title>
...
<body class="<?=$classes; ?>" <?=$attributes;?> onselectstart="return false"; onpaste="return false"; oncopy="return false;">
    <?=$page_top; ?>
    <?=$page; ?>
    <?=$page_bottom; ?>
</body>
