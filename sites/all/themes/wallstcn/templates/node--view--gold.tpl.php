...
<?endif?>
    ...
    <a class="pull-left news-img" style="height: 65px; width: 105px;" href="<?=url('node/'. $node->nid);?>" target="_blank">
        <div class="news-img-wrap">
            <img class="lazy" style="height: 60px; width: 100px;" src="/sites/all/themes/wallstcn/placeholder.gif" data-original="<?=wscn_image_domain(file_create_url($node->upload['und'][0]['uri']));?>"  alt="<?=$node->title?>" />
