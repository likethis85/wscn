...
(adsbygoogle = window.adsbygoogle || []).push({});
                ...
                <div class="random-ad" style="margin-bottom:0;">
                    <div class="carousel-inner">
                        <div class="active item"  data-probability="<?if(time() > strtotime(date('Y-m-d') . ' 09:00:00') && time() < strtotime(date('Y-m-d') . ' 18:00:00')):?>60<?else:?>30<?endif;?>">
                        ...
                        <div class="item" data-probability="<?if(time() > strtotime(date('Y-m-d') . ' 09:00:00') && time() < strtotime(date('Y-m-d') . ' 18:00:00')):?>40<?else:?>20<?endif;?>">
                            <div style="margin:0 auto;">
