...
<div class="random-ad" style="margin-bottom:0;">
    <div class="carousel-inner">
        ...
        <div class="active item" data-probability="<?if(time() > strtotime(date('Y-m-d') . ' 09:00:00') && time() < strtotime(date('Y-m-d') . ' 21:00:00')):?>40<?else:?>50<?endif;?>">
        ...
        <div class="item" data-probability="<?if(time() > strtotime(date('Y-m-d') . ' 09:00:00') && time() < strtotime(date('Y-m-d') . ' 21:00:00')):?>50<?else:?>50<?endif;?>">
            <div style="height:280px;margin:0 auto;">
