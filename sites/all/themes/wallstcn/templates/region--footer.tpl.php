...
<ul class="border-edge clearfix">
    <li class="border-blue"></li>
    <li class="border-red"></li>
    <li class="border-green"></li>
    <li class="border-orange"></li>
    <li class="border-blue-light"></li>
    <li class="border-yellow"></li>
</ul>
...
<div class="footer-content">
    ...
    <div class="row-fluid">
        ...
        <div class="span2">
            ...
            <ul>
                ...
                <li><a rel="nofollow" target="_blank" href="http://t.qq.com/wallstreetcn">腾讯微博</a></li>
                <li><a href="http://wallstreetcn.com/feed" target="_blank">RSS订阅</a></li>
    ...
    <p class="friend-links">友情链接：
        ...
        <a href="http://www.cifco.net/" target="_blank">中国国际期货有限公司</a> |
        <a href="http://www.citicsf.com/" target="_blank">中证期货有限公司</a> |
        <a href="http://www.sci99.com/" target="_blank">卓创资讯</a> |
    ...
    <div class="copyright">
        © 2010-2014 <a href="/" target="_blank" class="">华尔街见闻 wallstreetcn.com</a>
    <a href="http://www.miibeian.gov.cn/" rel="nofollow" target="_blank">沪ICP备13019121号</a>
    </div>
